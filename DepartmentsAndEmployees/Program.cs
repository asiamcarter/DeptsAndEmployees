...
namespace DapperDepartments
{
    class Program
    {
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            {
                if (employ.Department != null)
                {
                    
                    Console.WriteLine($"{employ.Id}: {employ.FirstName} {employ.LastName}. Dept: {employ.Department.DeptName}");
                }
                else
                {
                    
                    Console.WriteLine($"{employ.Id}: {employ.FirstName} {employ.LastName}");
                }
            }
        }
        /// <summary>
